...
const DEFAULT_PROJECTS = [
  { number: "5502-M046", name: "MG Switch - Solenoid Assy & Check" },
  { number: "5502-M047", name: "MG Switch - CUP WASHER CAULKING" },
  { number: "5502-M028", name: "MC Starter Add-On Commutator Finishing MC" },
  { number: "5502-M029", name: "MC Starter Add-On Comutator V2 Project" },
  { number: "5502-M061", name: "Contact Moving PF" },
  { number: "5502-M062", name: "MG Switch - Coil Assy Press Fitting" },
  { number: "5502-M060", name: "MG Switch- Pallet Magnetic Switch" },
  { number: "5502-M051", name: "Final Caulking HDI" },
  { number: "5514-M037", name: "ACGS Improvement No Soldering" },
  { number: "5514-M051", name: "ACGS AUTODRILLING" },
  { number: "5508-K001", name: "VCT camera check" },
  { number: "7211-M054", name: "HVAC Line 10" },
  { number: "7215-M050", name: "MC Tube Double Head Bender No.4" },
  { number: "7215-M061", name: "Camera Check Thread Nut Spinning 2 & 4" },
  { number: "7451-M016", name: "ECU New ATS 3 Soldering Line 2" },
  { number: "DMIA-M006", name: "Winding Overflow Visual Check" },
  { number: "5513-M004", name: "Support add prog Gell Aplying Machine" },
  { number: "0", name: "Tube Line 11 (SAB MC)" },
  { number: "0", name: "Hose Auto Bulging (add oil spray)" },
  { number: "0", name: "Tube assy Line 2,3 Improve (Panji)" },
  { number: "0", name: "HDI add NG hstory Line 8" },
  { number: "0", name: "Add safety Interlock Core assy condensor (KAIZEN)" }
];
